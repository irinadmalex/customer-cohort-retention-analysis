...
Когортный анализ когорт клиентов (Дек 2010 - Дек 2011) для выявления паттернов удержания и расчёта lifetime value.

### Ключевые вопросы:
- Как долго клиенты остаются активными?
- Когда наступает критическая точка оттока?
...
##   Ключевые находки
  ...
  **Критичный первый месяц** - 70-80% клиентов уходят после первой покупки  
...
- **Источник данных:** [Данные Kaggle](https://www.kaggle.com/datasets/ulrikthygepedersen/online-retail-dataset)
